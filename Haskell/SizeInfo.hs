...
baseStats xs = unlines [
        ...
        "Average height: " ++ show (avgWidth xs),
        "Average width: " ++ show (avgWidth xs)
        ]
...
stats totalInfo = unlines ([
    ...
    baseStats totalInfo] ++ dropSizesStats totalInfo [200, 150, 120, 100, 75, 50])
    where
